...
handler = RotatingFileHandler('/home/langston/pave-prism/logs/balance_resync.log', 'a+', (1000**2)*200, 2)
...
def run_on_user(access_token, user_id):
    ...
    if response.status_code != 200:
        ...
        if len(transactions) > 0:
            ...
            # This is to set the start_date param to the earliest transaction
